...
set rc [catch {
  ...
  add_files -quiet E:/ECEC302/mux_problem2/mux_problem2.runs/synth_1/mux4.dcp
  read_xdc E:/ECEC302/mux_problem2/mux_problem2.srcs/constrs_1/new/constr.xdc
...
set rc [catch {
  ...
  catch { report_drc -file mux4_drc_routed.rpt -pb mux4_drc_routed.pb }
  ...
  catch { report_power -file mux4_power_routed.rpt -pb mux4_power_summary_routed.pb }
...
set rc [catch {
  ...
  catch { write_sysdef -hwdef mux4.hwdef -bitfile mux4.bit -meminfo mux4.mmi -ltxfile debug_nets.ltx -file mux4.sysdef }
