...
set_property PACKAGE_PIN E19 [get_ports {f[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f[0]}]
set_property PACKAGE_PIN U19 [get_ports {f[1]}]					
...
#set_property PACKAGE_PIN L1 [get_ports {led[15]}]					
    ...
    #set_property PACKAGE_PIN T17 [get_ports ld_en]                        
    #    set_property IOSTANDARD LVCMOS33 [get_ports ld_en]
